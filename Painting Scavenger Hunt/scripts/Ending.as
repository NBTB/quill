package scripts
{
    ...
    class Ending extends BaseMenu
    {
        ...
        public function Ending(xPos:int, yPos:int, widthVal:int, heightVal:int):void
        {
			...
			ending.text = "Congratulations! You have solved all of the riddles! Although no clues remain, there is still plenty to discover and learn. Perhaps there is another secret to be discovered?";
			ending.x = 10;
			ending.y = ending.x;
