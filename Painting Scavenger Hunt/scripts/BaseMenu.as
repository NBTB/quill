package scripts
{
	...
	public class BaseMenu extends MovieClip
	{
		...
		public static var titleFormat:TextFormat = new TextFormat("Monotype Corsiva", 30, 0xEEBB55, true);
		public static var bodyFormat:TextFormat = new TextFormat("Monotype Corsiva", 26, 0xCC9933);
		public static var captionFormat:TextFormat = new TextFormat("Monotype Corsiva", 20, 0xCC9933, null, true);
		public static var textButtonFormat:TextFormat = new TextFormat("Monotype Corsiva", 30, 0xE5E5E5);
		public static var linkUsableFormat:TextFormat = new TextFormat("Monotype Corsiva", 20, 0xE5E5E5);
		public static var linkUnusableFormat:TextFormat = new TextFormat("Monotype Corsiva", 20, 0xFE5E5A);
		public static var linkAccentuatedFormat:TextFormat = new TextFormat("Monotype Corsiva", 20, 0xE5E5E5, true);
