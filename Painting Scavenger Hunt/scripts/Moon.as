package {
	...
	public class Moon extends SimpleButton {

		public var captionText:String;
		public var isOver:Boolean;
		public var clue:String;

		public function Moon(captionText:String, xPos:Number = 0, yPos:Number = 0) {

			isOver=false;
			this.captionText=captionText;
			x=xPos;
			y=yPos;
			clue = "My appearance is always different, but I always have the same face...";
